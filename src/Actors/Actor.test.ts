...
it("Will have new status effects applied", () => {
  const actor = new BaseActor(3)
  const statusEffect = {name: "test", valueOf() {return 0}} as StatusEffect
...
it("Will not apply a lower value status effect", () => {
  const actor = new BaseActor(3)
  const mediumStatusEffect = {name: "test", valueOf() {return 2}} as StatusEffect
  actor.applyStatusEffect(mediumStatusEffect)
  const lowStatusEffect = {name: "test", valueOf() {return 1}} as StatusEffect
...
it("Will apply a higher value status effect", () => {
  ...
  const mediumStatusEffect = {name: "test", valueOf() {return 2}} as StatusEffect
  actor.applyStatusEffect(mediumStatusEffect)
  const highStatusEffect = {name: "test", valueOf() {return 3}} as StatusEffect
